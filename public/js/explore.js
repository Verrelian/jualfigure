                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <a href="product/${product.id}" class="block">
                            <div class="aspect-square w-full">
                                <img src="${product.gambar_url}" alt="${product.name}" class="w-full h-full object-cover" loading="lazy">
                            </div>
                            <div class="p-3">
                                <p class="text-xs text-gray-500 mb-1">${product.type || 'Figure'}</p>
                                <h3 class="font-semibold text-sm mb-2 line-clamp-2" title="${product.name}">${product.name}</h3>
