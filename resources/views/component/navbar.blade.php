    ...
    <div class="flex-1 max-w-xl mx-6">
      <form>
        <div class="relative">
          ...
          <input type="search"
            class="block w-full p-2.5 ps-10 text-sm border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
            placeholder="Cari produk, pelanggan, pesanan..." />
          <button type="submit"
            class="absolute end-2.5 bottom-2 text-white bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-3 py-1">
            Cari
          </button>
        </div>
      </form>
