    ...
    <div class="flex justify-between items-center py-4">
      ...
      <div class="hidden md:flex items-center space-x-6">
        ...
        <a href="{{ route('history.placed') }}"
          class="{{ request()->routeIs('history.*') ? 'text-blue-600 font-medium border-b-2 border-blue-600' : 'text-gray-700 hover:text-blue-600 hover:border-b-2 hover:border-blue-600' }} py-2">
          History
        </a>
