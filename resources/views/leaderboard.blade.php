...
<body class="bg-gradient-to-b from-gray-300 to-gray-100 text-black min-h-screen">

  <!-- Header -->
  <div class="bg-black bg-opacity-80 text-white text-center py-4 text-2xl font-bold shadow-md">
    LEADERBOARD
  </div>
