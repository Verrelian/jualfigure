        ...
        <tbody>
            ...
            <tr class="text-center border-b hover:bg-gray-50">
                ...
                <td class="text-sm text-left py-2 px-4">
                    <span class="inline-block px-2 py-1 text-xs font-medium bg-green-200 text-green-800 rounded">
                        Completed
                    </span>
                </td>
                <td class="py-2 px-4 space-x-2">
                    <a href="{{ route('history.completed.detail', ['payment_id' => $order->payment_id]) }}"
