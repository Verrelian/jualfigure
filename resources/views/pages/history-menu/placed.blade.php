    ...
    <table class="min-w-full text-left text-sm table-fixed">
        ...
        <tbody>
            ...
            <tr class="text-center border-b hover:bg-gray-50">
                ...
                <td class="text-sm text-left py-2 px-4">
                    <span class="inline-block px-2 py-1 text-xs font-medium bg-yellow-100 text-yellow-700 rounded">
                        Waiting for payment
                    </span>
                </td>
                <td class="py-2 px-4 space-x-2">
                    <a href="{{ route('history.placed.detail', ['payment_id' => $order->payment_id]) }}"
