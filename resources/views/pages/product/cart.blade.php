                        ...
                        container.innerHTML = `
                            <div class="max-w-md mx-auto text-center">
                                <div class="bg-white rounded-2xl shadow-xl p-12 transform hover:scale-105 transition-transform duration-300">
                                    ...
                                    <a href='{{ route('products') }}' class='inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg transform hover:scale-105 transition-all duration-200'>
