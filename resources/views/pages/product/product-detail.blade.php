...
<div class="container mx-auto p-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        <div class="lg:pl-8">
            ...
            <!-- Product Title -->
            <h1 class="text-2xl lg:text-4xl font-bold text-gray-900 mb-6 leading-tight">
                {{ $product['title'] }}
            </h1>
            ...
            <div class="mb-8">
                ...
                <span class="text-gray-600 leading-relaxed">{{ $product['stock'] }}</span>
            </div>
            ...
            <!-- Specifications -->
            <div class="mb-8">
                <h3 class="font-semibold text-2xl text-gray-900 mb-4">Specifications</h3>
                <div class="space-y-3">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('checkout.form', $product['product_id']) }}" class="flex-1 bg-blue-600 hover:bg-blue-700 text-center text-white py-3 px-6 rounded-md font-medium transition-colors">
                    Buy Now
                </a>
