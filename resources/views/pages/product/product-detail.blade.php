...
@section('content')
    <div class="container mx-auto p-4">
            ...
            <div class="lg:pl-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex space-x-3">
                        <button id="addToCartBtn" class="flex-1 bg-gray-900 hover:bg-gray-800 text-white py-3 px-6 rounded-md font-medium transition-colors">
                            Add to Cart
                        </button>
                        <button id="buyNowBtn" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-md font-medium transition-colors">
                            Buy Now
                        </button>
                        <button id="wishlistBtn" class="border border-gray-300 hover:border-gray-400 p-3 rounded-md transition-colors group">
        ...
        @include('component.product.payment-modal')
        @include('component.product.bukti-modal')
        @include('component.product.reciept-modal')

        <!-- Related Products -->
        <div class="border-t border-gray-100 pt-16">
            <div class="flex items-center justify-between mb-8">
                <h2 class="text-xl font-bold text-gray-900">You might also like</h2>
                <a href="{{ route('explore') }}" class="text-sm text-blue-600 hover:text-blue-700 font-medium">
                    View all →
                </a>
            </div>
