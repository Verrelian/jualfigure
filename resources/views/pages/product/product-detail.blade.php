...
<div class="container mx-auto p-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        <div class="relative">
            ...
            <!-- Thumbnail Gallery (if you have multiple images) BEFORE-->
        ...
        <div class="lg:pl-8">
            ...
            <div class="mb-4">
                ...
                $hasHalfStar = ($rating - $fullStars) >= 0.25 && ($rating - $fullStars) < 0.75;
                    ...
                    <div class="mt-4 mb-4 flex items-center gap-0.5 text-yellow-400 text-lg">
